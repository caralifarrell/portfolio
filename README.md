...
|--------|-------------|-------------------|-------|
|[iOS & Swift - The Complete iOS App Development Bootcamp](https://github.com/caralifarrell/iOS-Swift-The-Complete-iOS-App-Development-Bootcamp) 📱|Online course to learn core programming concepts and build over 25 apps. It delves into key principles such as object-oriented programming, data structures, and software design.|Xcode, UIKit, SwiftUI, ARKit, CoreML, CoreData|February 2024 - Present|
|[Python Mega Course: Learn Python in 60 Days, Build 20 Apps](https://github.com/caralifarrell/Python-Mega-Course-Learn-Python-in-60-Days-Build-20-Apps) 💻|A course to develop Python skills and build 20 real-world applications from web development to data science.|Python|February 2024 - Present|
